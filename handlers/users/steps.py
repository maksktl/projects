...
async def bulldozers(call: types.CallbackQuery):
...
async def excavator(call: types.CallbackQuery):
...
async def bull_type(call: types.CallbackQuery):
...
async def exc_type(call: types.CallbackQuery):
